...
@section('content')
    <div class="card pt-2 mt-2">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('monhocManage.updateMonHoc') }}" class="form" name="formEditMonHoc"
                id="formeditmonhoc">
                {{ csrf_field() }}
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        <div class="my-5">
                            <input type="hidden" name="mamonhoc" id="mamonhoc" value="{{ $info->mamonhoc }}">
                            <div class="mb-3 align-items-center justify-content-center row">
                                ...
                                <div class="col-6">
                                    <select class="form-select" name="malop" id="malop">
                                        ...
                                        <option value="{{ $lop->malop }}" {{ $info->malop==$lop->malop ? 'selected': '' }} >{{$lop->malop}} : {{ $lop->tenlop }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="mb-3 align-items-center justify-content-center row">
                                ...
                                <div class="col-6">
                                    <select class="form-select" name="macanbo" id="macanbo">
                                        ...
                                        <option value="{{ $canbo->macanbo }}" {{ $info->macanbo==$canbo->macanbo ? 'selected': '' }}>{{$canbo->macanbo}} : {{ $canbo->hoten }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="mb-3 align-items-center justify-content-center row">
                                ...
                                <div class="col-6">
                                    <select class="form-select" name="mamon" id="mamon">
                                        ...
                                        <option value="{{ $mon->mamon }}" {{ $info->mamon==$mon->mamon ? 'selected': '' }}>{{$mon->mamon}} : {{ $mon->tenmon }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
