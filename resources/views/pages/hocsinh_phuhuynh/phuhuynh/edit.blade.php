...
@section('content')
    <div class="card pt-2 mt-2">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('phuhuynhManage.update') }}" class="form" name="formEditPhuHuynh"
                id="formeditphuhuynh">
                {{ csrf_field() }}
                @method("put")
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        <div class="my-5">
                            <input type="hidden" name="maphuhuynh" id="maphuhuynh" value="{{ $info->maphuhuynh }}">
